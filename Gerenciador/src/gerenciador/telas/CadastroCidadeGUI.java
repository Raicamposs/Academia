 ...
 * @author Raiane
 */
public class CadastroCidadeGUI extends javax.swing.JFrame {

    private int contTentativa = 0;
    private UsuarioDao con;
    private Usuario user;

    public CadastroCidadeGUI() {
        initComponents();
        con = new UsuarioDao();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 60, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Telas Pequenas/CadastroCidade.png"))); // NOI18N
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        this.setExtendedState(CadastroCidadeGUI.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroCidadeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
